...
import br.madufurini.loja.view.Forms.PedidoForm;
...
public class PedidoScreen extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cliente", "Data", "Valor ", "Produtos", "Status"
            }
        ));
        ...
        clienteBtn.setText("Registrar Pedido");
        ...
        clienteBtn2.setText("Excluir Pedido");
    ...
    private void clienteBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_clienteBtn2ActionPerformed
        ...
        if (resposta == JOptionPane.YES_OPTION) {
            Pedido pedido = pedidos.get(linhaSelecionada);
